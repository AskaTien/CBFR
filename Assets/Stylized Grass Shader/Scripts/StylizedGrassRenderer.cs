...
{
    [ExecuteInEditMode]
    [AddComponentMenu("Stylized Grass/Bending Renderer")]
    public class StylizedGrassRenderer : MonoBehaviour
    {
        ...
        [Tooltip("The renderer will follow this Transform's position. Ideally set to the player's transform. Note that this may induce flickering in the bending")]
